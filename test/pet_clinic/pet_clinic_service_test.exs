defmodule PetClinic.PetClinicServiceTest do
  ...
  describe "pethealthexperts" do
    ...
    test "list_pethealthexperts/0 returns all pethealthexperts" do
      ...
      assert PetClinicService.list_pethealthexperts() == [pet_health_expert]
    end

    test "get_pet_health_expert!/1 returns the pet_health_expert with given id" do
      pet_health_expert = pet_health_expert_fixture()
      assert PetClinicService.get_pet_health_expert!(pet_health_expert.id) == pet_health_expert
    end
    ...
    test "change_pet_health_expert/1 returns a pet_health_expert changeset" do
      pet_health_expert = pet_health_expert_fixture()
      assert %Ecto.Changeset{} = PetClinicService.change_pet_health_expert(pet_health_expert)
    end
  end
